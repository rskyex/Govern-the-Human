...
export function Footer() {
  return (
    <footer className="relative py-20 md:py-24 overflow-hidden">
      ...
      <div className="relative max-w-[1120px] mx-auto px-8 md:px-16 flex flex-col items-center text-center">
        <Image
          src="/logo.png"
        ...
        <p className="font-sans text-[13px] text-white/70 font-light mb-4">
          Research in progress
        </p>
        <div className="w-10 h-px bg-white/30 mb-6" />
        <p className="font-sans text-[0.85rem] leading-[1.8] text-white/75 font-light max-w-[520px] mb-6">
        ...
        <a
          ...
          className="font-sans text-[12px] tracking-[0.06em] text-white/60 hover:text-white/90 transition-colors duration-300"
        >
          risakoyanagi.com &rarr;
        </a>
        <p className="font-sans text-[11px] text-white/50 font-light mt-4">
          &copy; Risa Koyanagi
        </p>
      </div>
    </footer>
