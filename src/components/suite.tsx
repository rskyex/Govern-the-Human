...
function ObservatoryCanvas() {
  ...
  useEffect(() => {
    ...
    function draw() {
      ...
      ctx.strokeStyle = 'rgba(91,164,201,0.055)'; ctx.lineWidth = r * 0.04; ctx.stroke()
      ctx.restore()
...
function PlatformedCanvas() {
  ...
  useEffect(() => {
    ...
    function draw() {
      ...
      headPath(ctx, s * 0.62)
      ctx.strokeStyle = 'rgba(255,255,255,0.03)'; ctx.lineWidth = 0.4; ctx.stroke()
      ctx.restore()
